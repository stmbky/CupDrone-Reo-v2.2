...
/*************************************************************************************************/
  ...
  /********************************************************************/
    ...
    #define VBATLEVEL_WARN1  38 // (*) 3,7V
    #define VBATLEVEL_WARN2  37 // (*) 3.6V
    #define VBATLEVEL_CRIT   35 // (*) 3.5V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
